<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" placeholder="Enter program name" wire:model.lazy="program"
                                    class="form-control">
                ...
                <form wire:submit.prevent="edit">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="program" class="form-label">Program</label>
                                <input type="text" placeholder="Enter program name" value="{{ $program }}"
                                    wire:model.lazy="program" class="form-control">
                                <small class="text-danger">
                                    @error('program')
                                        {{ $message }}
                                    @enderror
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-6" >
            <h1 class="fw-bold py-3 my-1">{{ config('app.name') }} Programs</h1>
        </div>
