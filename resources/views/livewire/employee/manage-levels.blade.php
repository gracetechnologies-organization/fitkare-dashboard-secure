<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" placeholder="Enter level name" wire:model.lazy="level"
                                    class="form-control">
                ...
                <form wire:submit.prevent="edit">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="level" class="form-label">Level</label>
                                <input type="text" placeholder="Enter level name" value="{{ $level }}"
                                    wire:model.lazy="level" class="form-control">
                                <small class="text-danger">
                                    @error('level')
                                        {{ $message }}
                                    @enderror
    ...
    <div wire:ignore.self class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="deleteModalLabel">Delete Level</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        wire:click="resetModal"></button>
                </div>
